...
//autogenerated
class DataId_reflection implements \Sigmalab\SimpleReflection\ICanReflection
{
	/** DataId */
	private DataId $instance;

	public const Field_data_id = "data_id";

	
	public function __construct(DataId $instance) 
	{
	...
	public function getPropertyType(string $name) : \Sigmalab\SimpleReflection\TypeName
	{
		...
		switch ($name) {
			...
			default:
				//throw new ReflectionException("Property '{$name}' not found in DataId"); 
		}
...
/* int: int type:int isArray:  */
	...
	{   
		\Sigmalab\SimpleReflection\ClassRegistry::registerClass(DataId::class, function(){
			return instance_cast(new DataId, IReflectedObject::class ); 
		});
		\Sigmalab\SimpleReflection\ClassRegistry::registerReflection(self::class, function(object $instance){
			/** @noinspection PhpParamsInspection */ 
			return new DataId_reflection(instance_cast($instance, DataId::class)); 
		});
 ...
 //type: int 
			case 'get_data_id':
				...
				break;
			default:
				//throw new ReflectionException("Property '$methodName' not found in DataId");
	...
	public function invoke_as_void(string $methodName, array $args) :void
	{
		switch ($methodName)
		{
			...
			case 'getColumnDefinition':
				...
				break;
			case 'getDataIdPrototype':
				$this->invoke_getDataIdPrototype($args);
				break;
			case 'prototypeMap':
...
//param: int
		...
		else throw new ReflectionException("Property '0' not found in DataId");
...
//return: array
	 ...
	 * 
	 */
	private function invoke_getDataIdPrototype(array $args)
	{
//type: Parameter #0 [ <optional> string or NULL $alias = NULL ]
//param: string
...
//return: Database\DataId
		$this->instance->getDataIdPrototype($arg0);
	}
...
//return: array
	...
	public function set_as_string(string  $name, string $value):void
	{
		switch ($name) {
			default: 
			//throw new ReflectionException("Property '$name' not found in \Database\DataId");
		}
	}
	/**
	 * @param string $name
