...
/*
 *
 *  DONT EDIT THIS FILE. AUTO CREATED BY genflowjs.xsl
 *
...
export type <xsl:value-of select="$class"/>Type =  <xsl:value-of select="$use-baseclass"/><xsl:if test="$use-baseclass != ''">Type &amp;</xsl:if>
{
