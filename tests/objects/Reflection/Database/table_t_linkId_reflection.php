...
//autogenerated
class table_t_linkId_reflection implements \Sigmalab\SimpleReflection\ICanReflection
{
	/** table_t_linkId */
	private table_t_linkId $instance;

	public const Field_link_id = "link_id";

	
	public function __construct(table_t_linkId $instance) 
	{
	...
	public function getPropertyType(string $name) : \Sigmalab\SimpleReflection\TypeName
	{
		...
		switch ($name) {
			...
			default:
				//throw new ReflectionException("Property '{$name}' not found in table_t_linkId"); 
		}
...
/* int: int type:int isArray:  */
	...
	{   
		\Sigmalab\SimpleReflection\ClassRegistry::registerClass(table_t_linkId::class, function(){
			return instance_cast(new table_t_linkId, IReflectedObject::class ); 
		});
		\Sigmalab\SimpleReflection\ClassRegistry::registerReflection(self::class, function(object $instance){
			/** @noinspection PhpParamsInspection */ 
			return new table_t_linkId_reflection(instance_cast($instance, table_t_linkId::class)); 
		});
 ...
 //type: int 
			case 'get_link_id':
				...
				break;
			default:
				//throw new ReflectionException("Property '$methodName' not found in table_t_linkId");
	...
	public function invoke_as_void(string $methodName, array $args) :void
	{
		switch ($methodName)
		{
			...
			case 'getColumnDefinition':
				...
				break;
			case 'gettable_t_linkIdPrototype':
				$this->invoke_gettable_t_linkIdPrototype($args);
				break;
			case 'prototypeMap':
...
//param: int
		...
		else throw new ReflectionException("Property '0' not found in table_t_linkId");
...
//return: array
	 ...
	 * 
	 */
	private function invoke_gettable_t_linkIdPrototype(array $args)
	{
//type: Parameter #0 [ <optional> string or NULL $alias = NULL ]
//param: string
...
//return: Database\table_t_linkId
		$this->instance->gettable_t_linkIdPrototype($arg0);
	}
...
//return: array
	...
	public function set_as_string(string  $name, string $value):void
	{
		switch ($name) {
			default: 
			//throw new ReflectionException("Property '$name' not found in \Database\table_t_linkId");
		}
	}
	/**
	 * @param string $name
