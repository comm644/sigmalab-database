...
//autogenerated
class table_t_link_reflection implements \Sigmalab\SimpleReflection\ICanReflection
{
	/** table_t_link */
	private table_t_link $instance;
	...
	public function __construct(table_t_link $instance) 
	{
	...
	public function isPropertyExists(string $name):bool
	{
		//autogenerated map
		switch ($name) {
			case self::Field_link_id: return true;
	...
	public function getPropertyType(string $name) : \Sigmalab\SimpleReflection\TypeName
	{
		//autogenerated map
		switch ($name) {
			case self::Field_link_id: return \Sigmalab\SimpleReflection\TypeName::$intValue;
			...
			default:
				//throw new ReflectionException("Property '{$name}' not found in table_t_link"); 
		}
...
/* int: int type:int isArray:  */
		case self::Field_link_id:
			if ($value instanceof \Sigmalab\SimpleReflection\ValueScalar) {
				$this->instance->link_id = $value->get_as_int();
			}
...
/* int: int type:int isArray:  */
	...
	public function getPropertyValue(string $name) :\Sigmalab\SimpleReflection\ValueMixed
	{
		//autogenerated map
		switch ($name) {
			case self::Field_link_id: return new \Sigmalab\SimpleReflection\ValueScalar( $this->instance->link_id );
	...
	{   
		\Sigmalab\SimpleReflection\ClassRegistry::registerClass(table_t_link::class, function(){
			return instance_cast(new table_t_link, IReflectedObject::class ); 
		});
		\Sigmalab\SimpleReflection\ClassRegistry::registerReflection(self::class, function(object $instance){
			/** @noinspection PhpParamsInspection */ 
			return new table_t_link_reflection(instance_cast($instance, table_t_link::class)); 
		});
 ...
 //type: bool 
			case 'set_link_id':
				return $this->invoke_set_link_id($args);
				break;
 //type: int 
			case 'get_link_id':
				return $this->invoke_get_link_id($args);
				break;
 //type: bool 
			case 'set_data_id':
 ...
 //type: bool 
			case 'setValue':
				...
				break;
			default:
				//throw new ReflectionException("Property '$methodName' not found in table_t_link");
	...
	*/
	...
	public function invoke_as_void(string $methodName, array $args) :void
	{
		switch ($methodName)
		{
			case 'gettable_t_linkPrototype':
				$this->invoke_gettable_t_linkPrototype($args);
				break;
			...
			case 'isNew':
				...
				break;
			case 'set_link_id':
				$this->invoke_set_link_id($args);
				break;
			case 'get_link_id':
				$this->invoke_get_link_id($args);
				break;
			case 'set_data_id':
	 ...
	 * 
	 */
	private function invoke_gettable_t_linkPrototype(array $args)
	{
...
//param: string
		...
		else throw new ReflectionException("Property '0' not found in table_t_link");

//return: Database\table_t_link
		$this->instance->gettable_t_linkPrototype($arg0);
	}
...
//return: bool
	 ...
	 * 
	 */
	private function invoke_set_link_id(array $args)
	{
...
//return: bool
		return $this->instance->set_link_id($arg0);
	}
	 ...
	 * 
	 */
	private function invoke_get_link_id(array $args)
	{
//return: int
		return $this->instance->get_link_id();
	}
...
//param: mixed
		...
		else throw new ReflectionException("Property '1' not found in table_t_link");
...
//return: 
	 ...
	 * 
	 */
	private function invoke_tag_link_id(array $args)
	{
//type: Parameter #0 [ <optional> string or NULL $alias = NULL ]
//param: string
...
//return: Sigmalab\Database\Core\IDBColumnDefinition
		$this->instance->tag_link_id($arg0);
	}
...
//return: array
	 ...
	 * 
	 */
	private function invoke_key_data_id(array $args)
	{
...
//return: Sigmalab\Database\Core\DBForeignKey
		$this->instance->key_data_id($arg0);
	}
...
//return: Sigmalab\Database\Core\DBForeignKey
	...
	public function set_as_string(string  $name, string $value):void
	{
		switch ($name) {
			default: 
			//throw new ReflectionException("Property '$name' not found in \Database\table_t_link");
		}
	}
	/**
	 * @param string $name
	...
	{
		switch ($name) {
			case self::Field_link_id: $this->instance->link_id  = $value; break;
	...
	{
		switch ($name) {
			case self::Field_link_id: return (int)$this->instance->link_id;
	...
	{
		switch ($name) {
			case self::Field_link_id: $this->instance->link_id  = null; break;
	...
	public function set_as_mixed(string $name, $value):void
	{
		switch ($name) {
			case self::Field_link_id: 
				if ( is_null($value) ) $this->instance->link_id = null;
				else $this->instance->link_id  = (int)$value; 
				break;
			case self::Field_data_id: 
	...
	{
		switch ($name) {
			case self::Field_link_id: return $this->instance->link_id; break;
