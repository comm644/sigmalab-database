...
//	}
	...
	public function testCycle()
	{
		...
		$db = new FfiSqliteDataSource();
		$db->connect("sqlite://localhost/?database=$file");
...
//		$rc = $db->queryStatement($stmInsert, $container);
	...
	/**
	 * @param FfiSqliteDataSource $ds
	 * @return DBCommandContainer
	 * @throws DatabaseException
	 * @throws DatabaseBusyException
	 */
	protected function rollupSchema(FfiSqliteDataSource $ds): DBCommandContainer
	{
...
$test = new kphpFfiSqliteDatasource();
$test->testCycle();