...
CREATE TABLE t_subdetails (
  `subdetails_id` int NOT NULL  auto_increment 
  ,`details_id` int NOT NULL 
  ,`subDetailsData` int DEFAULT 0

  ,INDEX ix_t_subdetails_details_id(`details_id` )
  
  ,CONSTRAINT c_t_subdetails_subdetails_id PRIMARY KEY(`subdetails_id`)
...
CREATE TABLE t_propertiesOne (
  ...
  ,`base_id` int NOT NULL 
  ,`propertiesOneData` int DEFAULT 0
...
CREATE TABLE t_propertiesTwo (
  ...
  ,`base_id` int NOT NULL 
  ,`propertiesTwoData` int DEFAULT 0
...
CREATE TABLE t_dataNotNullable (
  `dataNotNullableId` int NOT NULL  auto_increment 
  ,`valueA` varchar(255) DEFAULT ''
  ,`valueB` varchar(255) DEFAULT ''

  
  ,CONSTRAINT c_t_dataNotNullable_dataNotNullableId PRIMARY KEY(`dataNotNullableId`)
...
CREATE TABLE t_datatime (
  `datatime_id` int NOT NULL  auto_increment 
  ,`value` datetime DEFAULT NULL 

  
  ,CONSTRAINT c_t_datatime_datatime_id PRIMARY KEY(`datatime_id`)
