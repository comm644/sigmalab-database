...
//autogenerated
class DataDateTimeId_reflection implements \Sigmalab\SimpleReflection\ICanReflection
{
	/** DataDateTimeId */
	private DataDateTimeId $instance;

	public const Field_datatime_id = "datatime_id";

	
	public function __construct(DataDateTimeId $instance) 
	{
	...
	public function getPropertyType(string $name) : \Sigmalab\SimpleReflection\TypeName
	{
		...
		switch ($name) {
			...
			default:
				//throw new ReflectionException("Property '{$name}' not found in DataDateTimeId"); 
		}
...
/* int: int type:int isArray:  */
	...
	{   
		\Sigmalab\SimpleReflection\ClassRegistry::registerClass(DataDateTimeId::class, function(){
			return instance_cast(new DataDateTimeId, IReflectedObject::class ); 
		});
		\Sigmalab\SimpleReflection\ClassRegistry::registerReflection(self::class, function(object $instance){
			/** @noinspection PhpParamsInspection */ 
			return new DataDateTimeId_reflection(instance_cast($instance, DataDateTimeId::class)); 
		});
 ...
 //type: int 
			case 'get_datatime_id':
				...
				break;
			default:
				//throw new ReflectionException("Property '$methodName' not found in DataDateTimeId");
	...
	public function invoke_as_void(string $methodName, array $args) :void
	{
		switch ($methodName)
		{
			...
			case 'getColumnDefinition':
				...
				break;
			case 'getDataDateTimeIdPrototype':
				$this->invoke_getDataDateTimeIdPrototype($args);
				break;
			case 'prototypeMap':
...
//param: int
		...
		else throw new ReflectionException("Property '0' not found in DataDateTimeId");
...
//return: array
	 ...
	 * 
	 */
	private function invoke_getDataDateTimeIdPrototype(array $args)
	{
//type: Parameter #0 [ <optional> string or NULL $alias = NULL ]
//param: string
...
//return: Database\DataDateTimeId
		$this->instance->getDataDateTimeIdPrototype($arg0);
	}
...
//return: array
	...
	public function set_as_string(string  $name, string $value):void
	{
		switch ($name) {
			default: 
			//throw new ReflectionException("Property '$name' not found in \Database\DataDateTimeId");
		}
	}
	/**
	 * @param string $name
